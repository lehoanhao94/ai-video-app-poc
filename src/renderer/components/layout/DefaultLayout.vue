<template>
  <div class="min-h-screen flex relative lg:static bg-surface-50 dark:bg-surface-950">
    <div
      id="app-sidebar-9"
      class="h-screen bg-surface-0 dark:bg-surface-950 hidden lg:block flex-shrink-0 absolute lg:static left-0 top-0 z-10 border-r border-surface w-72 lg:w-16 select-none"
    >
      <div class="flex flex-col h-full">
          ...
          <ul class="list-none p-0 m-0">
            <li @click="router.push('/')">
              ...
              >
                ...
                <span class="font-medium inline text-base lg:text-sm lg:hidden">Home</span>
              </a>
            </li>
            <li @click="router.push('/second')">
              <a
              ...
              >
                ...
                <span class="font-medium inline text-base lg:text-sm lg:hidden">Search</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span class="font-medium inline text-base lg:text-sm lg:hidden">Team</span>
              </a>
            </li>
            ...
            <li>
              ...
              >
                ...
                <span class="font-medium inline text-base lg:text-sm lg:hidden">Events</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span class="font-medium inline text-base lg:text-sm lg:hidden">Options</span>
              </a>
            </li>
          </ul>
        </div>
        <div class="mt-auto">
          ...
          >
            <i
              class="pi pi-sign-out mr-2 lg:mr-0 text-base lg:!text-2xl leading-none text-primary"
            />
    ...
    <div class="min-h-screen flex flex-col relative flex-auto">
      <div
        class="h-[60px] flex justify-between items-center px-8 bg-surface-0 dark:bg-surface-950 relative lg:static border-b border-surface"
      >
        <div class="flex">
          <a
            v-styleclass="{
          ...
          <li class="border-t border-surface lg:border-t-0">
            ...
            >
              ...
              <div class="block lg:hidden">
                <div class="text-surface-900 dark:text-surface-0 font-medium">Amy Elsner</div>
      ...
      <div
        id="rightsidebar"
        class="top-[60px] h-[calc(100%-60px)] bg-surface-0 dark:bg-surface-900 shadow hidden absolute right-0 w-80 animate-duration-150 animate-ease-in-out"
      >
        <div class="flex flex-col h-full p-6">
          <span class="text-xl font-medium text-surface-900 dark:text-surface-0 mb-4"
            >Right Sidebar</span
          >
          <div
